...
public class aciertos {
    ...
    /**
     * Método "main" de java, inicia el programa.
    ...
    public static void main(String[] args) {
        ...
        /**
         *  En el siguiente bucle do-while se comprueba si el número introducido es mayor "n>x" que el contenido en "x", 
         *  o menor "n<x" y se añade 1 a la variable contador "cont", siempre que el número introducido en "n" sea distinto de "x",
